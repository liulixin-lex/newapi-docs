...
![Terminal running npm list to check the Node.js and npm environment](/images/tutorial/manual-env-01-check-node-npm.webp)
...
![Terminal installing Claude Code, Codex, and Gemini CLI globally with npm](/images/tutorial/manual-env-02-install-cli-tools.webp)
...
![Terminal running claude to test the Claude Code installation](/images/tutorial/manual-env-03-test-claude.webp)
...
![Terminal running codex to test the Codex installation](/images/tutorial/manual-env-04-test-codex.webp)
...
![Terminal running gemini to test the Gemini CLI installation](/images/tutorial/manual-env-05-test-gemini.webp)
