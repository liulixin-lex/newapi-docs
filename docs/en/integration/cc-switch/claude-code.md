...
![CC-Switch initial interface for starting Claude Code setup](/images/tutorial/21.png)

2. In the group bar, switch the group to `Claude`.

![Claude group selected in the CC-Switch group bar](/images/tutorial/22.png)

3. In the provider group, choose `Custom configuration` as shown.

![Custom configuration provider selected for the Claude group](/images/tutorial/23.png)
...
![Copying the Claude group API key in the GGUU API console](/images/tutorial/24.png)

5. In the console, choose a low-latency `API request address` and copy it.

![Copying an API request address in the GGUU API console](/images/tutorial/25.png)
...
![Entering the Claude API key and request address in CC-Switch and adding the provider](/images/tutorial/26.png)
...
![Enabling the added Claude configuration in the CC-Switch main interface](/images/tutorial/27.png)
...
![CC-Switch settings with Skip Claude Code initial install confirmation enabled](/images/tutorial/28.png)

9. Run `claude` in a terminal. If the chat interface appears and replies normally, the configuration is complete.

![Terminal running Claude Code and opening the chat interface](/images/tutorial/29.png)
