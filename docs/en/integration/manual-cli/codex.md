...
![Windows Run dialog with the .codex configuration directory path](/images/tutorial/61.png)
...
![Codex configuration directory on Windows showing config.toml, auth.json, and AGENTS.md](/images/tutorial/62.png)
...
![Windows auth.json with OPENAI_API_KEY for Codex](/images/tutorial/63.png)
...
![Copying a Codex group token in the GGUU API console](/images/tutorial/64.png)
...
![Windows terminal running Codex and testing a response](/images/tutorial/65.png)
...
![macOS Go to Folder dialog with the .codex configuration directory path](/images/tutorial/66.png)
...
![Codex configuration directory on macOS showing config.toml, auth.json, and AGENTS.md](/images/tutorial/67.png)
...
![macOS auth.json with OPENAI_API_KEY for Codex](/images/tutorial/68.png)

Review [Create an API Token](/en/getting-started/api-token.html). Create a token in the Codex group in GGUU API, click the copy button on the right, then replace `xxx` with the key and save.

![Copying a Codex group token in the GGUU API console](/images/tutorial/69.png)
...
![macOS terminal running Codex and testing a response](/images/tutorial/70.png)
