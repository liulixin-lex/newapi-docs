...
![终端运行 npm list 命令检查 Node.js 和 npm 环境](/images/tutorial/46.png)
...
![终端通过 npm 全局安装 Claude Code、Codex 和 Gemini CLI](/images/tutorial/47.png)
...
![终端运行 claude 命令测试 Claude Code 安装结果](/images/tutorial/48.png)
...
![终端运行 codex 命令测试 Codex 安装结果](/images/tutorial/49.png)
...
![终端运行 gemini 命令测试 Gemini CLI 安装结果](/images/tutorial/50.png)
