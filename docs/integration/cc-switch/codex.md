...
![CC-Switch 初始界面，用于开始配置 Codex](/images/tutorial/30.webp)

1. 在分组条中，将分组选择至“Codex”

![CC-Switch 分组栏中选择 Codex 分组](/images/tutorial/31.webp)

1. 在供应商分组中，选择如图的“GGUUAI”

![Codex 分组中选择 GGUUAI 供应商](/images/tutorial/32.webp)

1. 回顾 [创建API令牌](/getting-started/api-token.html)，在 GGUU API 中创建 Codex 分组的令牌，点击复制按钮，复制API Key到剪切板

![GGUU API 控制台中复制 Codex 分组 API Key](/images/tutorial/33.webp)

1. 在控制台选择延迟低的“API 请求地址”进行复制。

![GGUU API 控制台中复制 API 请求地址](/images/tutorial/34.webp)
...
![CC-Switch 中填写 Codex 的 API Key 和带 /v1 的请求地址](/images/tutorial/35.webp)

1. 添加成功后，在主界面会看到我们配置的分组，在右侧点击“启用”按钮，显示“使用中”，则配置完成。

![CC-Switch 主界面中启用已添加的 Codex 配置](/images/tutorial/36.webp)

1. 在终端运行 codex，看到对话界面并能正常回复即表示配置完成。

![终端运行 Codex 并进入可对话界面](/images/tutorial/37.webp)
