...
![CC-Switch initial interface for starting Gemini setup](/images/tutorial/38.webp)

2. In the group bar, switch the group to `Gemini`.

![Gemini group selected in the CC-Switch group bar](/images/tutorial/39.webp)

3. In the provider group, choose `Custom configuration` as shown.

![Custom configuration provider selected for the Gemini group](/images/tutorial/40.webp)
...
![Copying the Gemini group API key in the GGUU API console](/images/tutorial/41.webp)

5. In the console, choose a low-latency `API request address` and copy it.

![Copying an API request address in the GGUU API console](/images/tutorial/42.webp)
...
![Entering the Gemini API key and request address in CC-Switch and adding the provider](/images/tutorial/43.webp)
...
![Enabling the added Gemini configuration in the CC-Switch main interface](/images/tutorial/44.webp)

8. Run `gemini` in a terminal. If the chat interface appears and replies normally, the configuration is complete.

![Terminal running Gemini and opening the chat interface](/images/tutorial/45.webp)
