...
![CC-Switch initial interface for starting Codex setup](/images/tutorial/cc-switch-codex-01-start-screen.webp)

2. In the group bar, switch the group to `Codex`.

![Codex group selected in the CC-Switch group bar](/images/tutorial/cc-switch-codex-02-select-group.webp)

3. In the provider group, choose `GGUUAI` as shown.

![GGUUAI provider selected for the Codex group](/images/tutorial/cc-switch-codex-03-gguuai-provider.webp)
...
![Copying the Codex group API key in the GGUU API console](/images/tutorial/shared-codex-token-console.webp)
...
![Entering the Codex API key and request address with /v1 in CC-Switch](/images/tutorial/cc-switch-codex-04-provider-form-v1.webp)
...
![Enabling the added Codex configuration in the CC-Switch main interface](/images/tutorial/cc-switch-codex-05-enable-config.webp)

8. Run `codex` in a terminal. If the chat interface appears and replies normally, the configuration is complete.

![Terminal running Codex and opening the chat interface](/images/tutorial/shared-codex-terminal-chat.webp)
