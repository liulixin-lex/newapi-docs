...
![终端运行 npm list 命令检查 Node.js 和 npm 环境](/images/tutorial/manual-env-01-check-node-npm.webp)
...
![终端通过 npm 全局安装 Claude Code、Codex 和 Gemini CLI](/images/tutorial/manual-env-02-install-cli-tools.webp)
...
![终端运行 claude 命令测试 Claude Code 安装结果](/images/tutorial/manual-env-03-test-claude.webp)
...
![终端运行 codex 命令测试 Codex 安装结果](/images/tutorial/manual-env-04-test-codex.webp)
...
![终端运行 gemini 命令测试 Gemini CLI 安装结果](/images/tutorial/manual-env-05-test-gemini.webp)
